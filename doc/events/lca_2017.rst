...
-  everybody touches documenation in some way or another
-  although Linux is at the forfront of OSS in some ways, kernel developers
   tend to be very conservative
-  so moving to a new documenation model takes some convincing
...
-  toward better kernel docs
   ...
   -  clean up the mess
   -  better formatted output with a logical toolchain
...
Writing less, saying more: UX lessions from the small screen
------------------------------------------------------------
Claire Mahoney
...
-  shake to send feedback is a neat way to hide some of the complexity of the
   full UI
-  context can be better thn words
...
-  I was at the back of the room and couldn't take notes :(
...
-  the lifecycle of a caterpillar is similar to the lifecycle of software
...
-  danger!
   ...
   -  danger signs include lots of FAQs, no introduction for new folks,
      docs not with code, lack of clear categorisation (IA)
